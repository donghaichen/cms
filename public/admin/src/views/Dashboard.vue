    ...
    <div class="content dashboard">
        ...
        <div class="visit">
            <Card :bordered="false">
                ...
                <div class="ivu-row">
                    <Col span="16" style=" padding-left: 12px;padding-right: 12px;">
                        <h4>流量分析</h4>
                        <p><ve-histogram :data="visitData"></ve-histogram></p>
                    </Col>
                    <Col span="8"  style="padding-left: 12px;padding-right: 12px;">
                        <h4>官方公告</h4>
                        <Steps :current="0" direction="vertical" style="margin: 40px 0 0 30px">
                            <Step title="2019年" content="发布3.0.0 Stable 版本"></Step>
                            <Step title="2019年" content="发布3.0.0 Stable 版本"></Step>
                            <Step title="2019年" content="发布3.0.0 Stable 版本"></Step>
                            <Step title="2019年" content="发布3.0.0 Stable 版本"></Step>
<!--                            <Step title="2019年" content="发布3.0.0 Stable 版本"></Step>-->
...
<!--                        <Timeline pending>-->
<!--                            <TimelineItem><a href="#">发布3.0.0 Stable 版本</a><p class="time">2019年</p></TimelineItem>-->
<!--                            <TimelineItem><a href="#">发布2.0.0 Stable 版本</a><p class="time">2017年</p></TimelineItem>-->
<!--                            <TimelineItem><a href="#">发布1.0.0 Stable 版本</a><p class="time">2015年</p></TimelineItem>-->
<!--                            <TimelineItem><a href="#">发布1.0.0 RC 版本</a><p class="time">2014年</p></TimelineItem>-->
<!--                            <TimelineItem><a href="#">发布1.0.0 Beta 版本</a><p class="time">2011年</p></TimelineItem>-->
<!--                            <TimelineItem><a href="#">发布1.0.0 Alpha 版本</a><p class="time">2011年</p></TimelineItem>-->
<!--&lt;!&ndash;                            <TimelineItem><a href="#">查看更多</a></TimelineItem>&ndash;&gt;-->
<!--                        </Timeline>-->
                    </Col>
                </div>
